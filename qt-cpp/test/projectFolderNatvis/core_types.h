...
inline CoreTypes::CoreTypes()
    ...
    , qFile(QStringLiteral("qt-cpp/res/natvis/qt6.natvis"))
    , qFileInfo(QStringLiteral("qt-cpp/res/natvis/qt6.natvis"))
    ...
    , qSize(42, 43)
    , qSizeF(4.1, 4.2)
    , qUrl(QStringLiteral("https://user:pass@github.com/narnaud/natvis4qt?ref=main#section1"))
