...
func (m ListModel) View() string {
	...
	if m.done {
		...
		return sty.Marker.Render(string(MarkingDone)) +
	...
	return sty.Marker.Render(string(MarkingQuestion)) +
		sty.Question.Render(m.prompt.question) + "\n\n" +
...
// helpers
func (m *ListModel) createSelection() Selection {
	all := Selection{}
...
func (m *ListModel) selectionToResultString() string {
	if m.prompt.compType == CompTypePicker {
