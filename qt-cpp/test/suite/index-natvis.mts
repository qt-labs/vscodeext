...
// This index is used exclusively for natvis/integration tests.
// It should not import unit tests or non-build suites, so that
// CMake Tools is only triggered when we actually want to test natvis.
...
export function run(): Promise<void> {
  ...
  return new Promise((resolve, reject) => {
    ...
    const g = new glob.Glob('natvis.test.js', { cwd: testsRoot });
