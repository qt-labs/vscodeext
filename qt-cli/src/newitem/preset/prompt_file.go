...
type PromptFileContents struct {
	...
	Consts  []utils.StringAnyMap `yaml:"consts" json:"consts"`
}
...
func (f *PromptFile) ExtractDefaults() utils.StringAnyMap {
	all := utils.StringAnyMap{}
...
func (fc *PromptFileContents) UpdateDefaultValues(options utils.StringAnyMap) {
